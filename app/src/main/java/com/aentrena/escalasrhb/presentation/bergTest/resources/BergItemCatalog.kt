    ...
    val definitions: Map<BergItemType, BergItemDefinition> = mapOf(
        ...
        BergItemType.SITTING_TO_STANDING to BergItemDefinition(
            ...
            scoringOptions = listOf(
                BergScoreOption(4, R.string.berg_sittingtostanding_score_4),
                BergScoreOption(3, R.string.berg_sittingtostanding_score_3),
                BergScoreOption(2, R.string.berg_sittingtostanding_score_2),
                BergScoreOption(1, R.string.berg_sittingtostanding_score_1),
                BergScoreOption(0, R.string.berg_sittingtostanding_score_0),
            ),
            needsTimer = false
        ),
        // Item 2
        BergItemType.STANDING_UNSUPPORTED to BergItemDefinition(
            ...
            scoringOptions = listOf(
                BergScoreOption(4, R.string.berg_standingunsupported_score_4),
                BergScoreOption(3, R.string.berg_standingunsupported_score_3),
                BergScoreOption(2, R.string.berg_standingunsupported_score_2),
                BergScoreOption(1, R.string.berg_standingunsupported_score_1),
                BergScoreOption(0, R.string.berg_standingunsupported_score_0),
            ),
            needsTimer = true
        ),
        // Item 3
        BergItemType.SITTING_WITH_BACK_UNSUPPORTED to BergItemDefinition(
            ...
            scoringOptions = listOf(
                BergScoreOption(4, R.string.berg_sittingwithbackunsupported_score_4),
                BergScoreOption(3, R.string.berg_sittingwithbackunsupported_score_3),
                BergScoreOption(2, R.string.berg_sittingwithbackunsupported_score_2),
                BergScoreOption(1, R.string.berg_sittingwithbackunsupported_score_1),
                BergScoreOption(0, R.string.berg_sittingwithbackunsupported_score_0),
            ),
            needsTimer = true
        ),
        // Item 4
        BergItemType.STANDING_TO_SITTING to BergItemDefinition(
            ...
            scoringOptions = listOf(
                BergScoreOption(4, R.string.berg_standingtositting_score_4),
                BergScoreOption(3, R.string.berg_standingtositting_score_3),
                BergScoreOption(2, R.string.berg_standingtositting_score_2),
                BergScoreOption(1, R.string.berg_standingtositting_score_1),
                BergScoreOption(0, R.string.berg_standingtositting_score_0),
            ),
            needsTimer = false
        ),
        // Item 5
        BergItemType.TRANSFERS to BergItemDefinition(
            ...
            scoringOptions = listOf(
                BergScoreOption(4, R.string.berg_transfers_score_4),
                BergScoreOption(3, R.string.berg_transfers_score_3),
                BergScoreOption(2, R.string.berg_transfers_score_2),
                BergScoreOption(1, R.string.berg_transfers_score_1),
                BergScoreOption(0, R.string.berg_transfers_score_0),
            ),
            needsTimer = false
        ),
        // Item 6
        BergItemType.STANDING_UNSUPPORTED_EYES_CLOSED to BergItemDefinition(
            ...
            scoringOptions = listOf(
                BergScoreOption(4, R.string.berg_standingunsupportedwitheyesclosed_score_4),
                BergScoreOption(3, R.string.berg_standingunsupportedwitheyesclosed_score_3),
                BergScoreOption(2, R.string.berg_standingunsupportedwitheyesclosed_score_2),
                BergScoreOption(1, R.string.berg_standingunsupportedwitheyesclosed_score_1),
                BergScoreOption(0, R.string.berg_standingunsupportedwitheyesclosed_score_0),
            ),
            needsTimer = true
        ),
        // Item 7
        BergItemType.STANDING_UNSUPPORTED_FEET_TOGETHER to BergItemDefinition(
            ...
            scoringOptions = listOf(
                BergScoreOption(4, R.string.berg_standingunsupportedwithfeettogether_score_4),
                BergScoreOption(3, R.string.berg_standingunsupportedwithfeettogether_score_3),
                BergScoreOption(2, R.string.berg_standingunsupportedwithfeettogether_score_2),
                BergScoreOption(1, R.string.berg_standingunsupportedwithfeettogether_score_1),
                BergScoreOption(0, R.string.berg_standingunsupportedwithfeettogether_score_0),
            ),
            needsTimer = true
        ),
        // Item 8
        BergItemType.REACHING_FORWARD_OUTSTRETCHED_ARM to BergItemDefinition(
            ...
            scoringOptions = listOf(
                BergScoreOption(4, R.string.berg_reachingforwardwithoutstretchedarmwhilestanding_score_4),
                BergScoreOption(3, R.string.berg_reachingforwardwithoutstretchedarmwhilestanding_score_3),
                BergScoreOption(2, R.string.berg_reachingforwardwithoutstretchedarmwhilestanding_score_2),
                BergScoreOption(1, R.string.berg_reachingforwardwithoutstretchedarmwhilestanding_score_1),
                BergScoreOption(0, R.string.berg_reachingforwardwithoutstretchedarmwhilestanding_score_0),
            ),
            needsTimer = false
        ),
        // Item 9
        ...
        BergItemType.STANDING_ON_ONE_LEG to BergItemDefinition(
            ...
            scoringOptions = listOf(
                BergScoreOption(4, R.string.berg_standingononeleg_score_4),
                BergScoreOption(3, R.string.berg_standingononeleg_score_3),
                BergScoreOption(2, R.string.berg_standingononeleg_score_2),
                BergScoreOption(1, R.string.berg_standingononeleg_score_1),
                BergScoreOption(0, R.string.berg_standingononeleg_score_0),
            ),
            needsTimer = true
        ),
    )
