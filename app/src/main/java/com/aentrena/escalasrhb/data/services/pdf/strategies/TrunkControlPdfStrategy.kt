...
import com.aentrena.escalasrhb.data.services.pdf.items.TrunkControlItemPdf
...
class TrunkControlPdfStrategy(private val context: Context): TestPdfStrategy {
    ...
    override fun drawContent(
        ...
        val trunkControlTest = test as? TrunkControlTest ?: return layout.margin
        ...
        trunkControlTest.side?.let { side ->
        ...
        val itemsPdf = prepareItemsForPdf(trunkControlTest)
    ...
    private fun prepareItemsForPdf(trunkControlTest: TrunkControlTest): List<TrunkControlItemPdf> {
        val definitions = TrunkControlItemCatalog.definitions
        return trunkControlTest.items.mapIndexedNotNull { index, item ->
            ...
            TrunkControlItemPdf(index + 1, definition, item, trunkControlTest, scoreDescription, context)
        }
    }
    ...
    private fun drawItem(canvas: Canvas, item: TrunkControlItemPdf, y: Float, layout: PdfLayout): Float {
